...
def search_definite_transactions(transactions: list, searching_str: str) -> list:
    """Функция отфильтровывает банковские операции по графе описания"""
    if not transactions:
        raise ValueError('Список словарей пуст')
    else:
        founded_transactions = []
        pattern = re.compile(searching_str)
        for transaction in transactions:
            if pattern.search(transaction.get('description', '')):
                founded_transactions.append(transaction)
...
b_transactions = [{'id': 441945886, 'state': 'EXECUTED', 'date': '2019-08-26T10:50:58.294041',
