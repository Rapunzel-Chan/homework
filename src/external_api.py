...
def calculate_currency_exchange(transactions: list) -> float:
    """Функция возвращает сумму трансакций в рублях с учетом курса валют"""
    ...
    total_euro_amount = 0.0
    total_rub_amount = 0.0
    ...
    total_amount = round(float(total_usd_amount + total_euro_amount + total_rub_amount), 2)
    return total_amount
