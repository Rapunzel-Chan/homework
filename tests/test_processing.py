...
def test_filter_by_state_missing(data):
...
def test_sort_by_date_wrong_type():
    with pytest.raises(ValueError):
        sort_by_date([{'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
                        {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
                        {'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-30'}])
